...
def ReadFile(inputFile, mappedFile):
    ...
    if(inputFileTokens == None):
        ...
        # Create the character array holding all the bytes read from the file
        dataToValidate = []
        ...
        # Convert the char array into a string using join with an empty character as the seperator.
